          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="mt-6 text-sm text-stone-500">
                <span className="font-bold text-stone-900">50k+ cooks</span>{" "}
                joined last month
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-stone-600 text-xl font-light">
              Everything you need to master your meal preparation.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className={"p-8"}>
                    ...
                    <h3 className="text-2xl font-bold nb-3">{feature.title}</h3>
